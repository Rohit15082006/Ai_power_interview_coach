...
class InterviewCoachGUI:
    ...
    def setup_control_panel(self):
        ...
        # FIX: Change this to use pack for all controls in this frame
        # Record button 
        ...
        # Recording buttons frame - use pack instead of grid
        recording_buttons_frame = ttk.Frame(control_frame)
        recording_buttons_frame.pack(pady=5)
        
         # Pause/Resume button - use pack instead of grid
        ...
        # Cancel button - use pack instead of grid
