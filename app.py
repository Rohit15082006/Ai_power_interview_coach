...
# API keys
openai_api_key = "2e2f667809834838bf3e8fbd17973c4c"
huggingface_api_key = "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"
...
st.write(""" Welcome to AI Interview Coach! This tool uses advanced AI to create personalized mock interview videos. Perfect for practice, these videos simulate real interview scenarios tailored to your role and experience level. Get ready to ace your next interview! 🚀 """)
...
st.sidebar.title("🚀 About AI Interview Coach")
st.sidebar.info(""" AI Interview Coach is an innovative tool that leverages AI to create realistic mock interview videos.   🔧 Features: - Custom scenarios - Role-specific questions - AI-generated visuals - Professional voice-overs  🌈 Created by:  window wizard team """)
